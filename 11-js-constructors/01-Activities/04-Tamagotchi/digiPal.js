...
var DigitalPal = function () {
    ...
    this.play = function () {
        if (this.bord === true) {
            console.log("Yey, let's play!")
            this.bord = false
            this.hungry = true
        } else {
            console.log ("not tright now, later please")
        }
    }
    ...
    increaseAge = function () {
        this.age++
        console.log('happy birthday to me, I am ', this.age ,"yrs old")
    }

}

var tamagoch = new DigitalPal()
console.log('tama: ' + JSON.stringify(tamagoch))
...
DigitalPal.prototype.furTreatment = function () {console.log('whoo hoo! I love it')}
cat.furTreatment()
dog.furTreatment()
cat.meow = function () {
...
cat.buyNewFurniture = function () {
    this.houseCondition += 50
    console.log("are you sure? why not")
}
console.log(cat)
tamagoch.sleep();
console.log(tamagoch)
