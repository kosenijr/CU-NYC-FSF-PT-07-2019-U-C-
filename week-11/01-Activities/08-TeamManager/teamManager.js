...
// dependency on inquirer package
const inquirer = require("inquirer");
// create a specific coinflip method
...
const Player = function(nameInput, positionInput, offenseInput, defenseInput) {
    this.name = nameInput;
    ...
    // Player.prototype.badGame = function() {
        let player = [];
        for (let k = 0; k < 100; k++) {
            player.push(new Player("Kay", "sub", 0, 0))
        }
    ...
    this.printStats = function(print) {
